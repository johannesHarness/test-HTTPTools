...
public class LEDMatrixBTConn {
    ...
    public int getXSize() { return this.mXSize; }

    public int getYSize() { return this.mYSize; }
    ...
    private boolean checkIfDeviceIsPaired() {
        ...
        for (BluetoothDevice device : mBluetoothAdapter.getBondedDevices()) {
            ...
            if (device.getName() != null && device.getName().equals(mRemoteBTDeviceName)) {
